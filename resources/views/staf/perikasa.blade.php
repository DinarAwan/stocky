@extends('example.layouts.default.dashboardStaf')
@section('content')
                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        ...
                        <tr class="text-gray-50"> 
                            {{-- class="{{ $item->status === 'pending' ? 'bg-red-50 text-gray-50' : 'bg-green-100 text-green-800' }}" --}}
                            <td class="w-4 p-4">
                                {{-- <div class="flex items-center">
                            ...
                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $item->catatan ?? '-'}}</td>
                                ...
                                <td class="p-4 space-x-2 whitespace-nowrap">
                                    <a href="#" type="button" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
