    ...
    <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
      <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
        <ul class="pb-2 space-y-2">
          ...
          <li>
            <a href="/dashboard/manager" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
          ...
          <li>
            <a href="/produkManager" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
            ...
            </svg>              <span class="ml-3" sidebar-toggle-item>Produk</span>
          </a>
          </li>
          <li>
            <a href="/supplierManager" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
              <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                <path d="M16 0H4a2 2 0 0 0-2 2v1H1a1 1 0 0 0 0 2h1v2H1a1 1 0 0 0 0 2h1v2H1a1 1 0 0 0 0 2h1v2H1a1 1 0 0 0 0 2h1v1a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2Zm-5.5 4.5a3 3 0 1 1 0 6 3 3 0 0 1 0-6ZM13.929 17H7.071a.5.5 0 0 1-.5-.5 3.935 3.935 0 1 1 7.858 0 .5.5 0 0 1-.5.5Z"/>
            </svg>              <span class="ml-3" sidebar-toggle-item>Supplier</span>
          </a>
          </li>
          ...
          <li>
            ...
            <ul id="dropdown-crud" class="space-y-2 py-2 {{ Request::is('crud/*') ? 'block' : 'hidden' }}">
              <li>
                <a href="/stok" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                  {{ Request::is('crud/products') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                  Barang Masuk/keluar
                </a>
              </li>
              <li>
                <a href="/stok-create" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                  {{ Request::is('crud/products') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                  Catat
                </a>
              </li>
          ...
          <li>
            ...
            <ul id="dropdown-pages" class="hidden py-2 space-y-2">
              <li>
                <a href="{{ url('example/pages/pricing/') }}" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">
                  Laporan Stok Barang</a>
              </li>
              <li>
                <a href="{{ url('example/pages/maintenance/') }}" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">
                  Laporan Barang Masuk Dan Keluar</a>
              </li>
