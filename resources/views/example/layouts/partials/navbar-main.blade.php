    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start">
        <a href="{{ url('/') }}" class="flex mr-4">
          ...
          <span class="ml-4 self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Stockify</span>
        </a>
      ...
      <div>
        <a href="#"
          class="mr-4 text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
