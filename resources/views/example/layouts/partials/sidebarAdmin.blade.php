        ...
        <ul class="pb-2 space-y-2">
          ...
          <li>
            ...
            <ul id="dropdown-crud" class="space-y-2 py-2 {{ Request::is('crud/*') ? 'block' : 'hidden' }}">
              <li>
                <a href="/produk" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                  {{ Request::is('crud/products') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                  Products
                </a>
              </li>
              <li>
                <a href="/supplier" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                {{ Request::is('example/crud/users') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                Suppliers
              </a>
              
              <li>
                <a href="/kategori" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                {{ Request::is('example/crud/users') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                Kategori
              </a>
              <li>
                <a href="/users" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                {{ Request::is('example/crud/users') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                Users
              </a>
              </li>
          ...
          <li>
            ...
            </svg>                <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Stock</span>
                <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
            </button>
            <ul id="dropdown-pages" class="hidden py-2 space-y-2">
              <li>
                <a href="/stokAdmin" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Barang Masuk/Keluar</a>
              </li>
              <li>
                <a href="#" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Opname</a>
              </li>
              
            </ul>
          </li>
          <li>
            <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700" aria-controls="dropdown" data-collapse-toggle="dropdown">
            ...
            <ul id="dropdown" class="hidden py-2 space-y-2">
              <li>
                <a href="#" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Stok Barang</a>
              </li>
              <li>
                <a href="#" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Barang Masuk/Keluar</a>
              </li>
              <li>
                <a href="#" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Aktivitas</a>
              </li>
          ...
          <li>
            <a href="#" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 {{ $page_slug == 'settings' ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
          ...
          {{-- -- --}}
          <li>
            <a href="/logout" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-red-500 group dark:text-gray-200 dark:hover:bg-gray-700 {{ $page_slug == 'settings' ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
